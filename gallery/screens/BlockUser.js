...
export default class BlockUser extends React.Component {
    ...
    setUsersOnBlockedUsersNode(id,name,email,url) {
                            ...
                            <View>
                                ...
                                <View style={styles.button1}>
                                    ...
                                    <View style={styles.view2}>
                                        <TouchableOpacity
                                             onPress={() => { this.setUsersOnBlockedUsersNode(item.id,
                                             item.name,item.email,item.url)}}
                                        >
                                            <Text style={styles.buttonText1}>{String.textFields.blockButton}</Text>
                                        </TouchableOpacity>
                                    </View>
                                </View>
                            </View>
                ...
                >
                    ...
                    <View style={styles.container}>
                        <View style={styles.titleView}>
                            <Text style={styles.text1}>{String.textFields.blockTitle}</Text>
                        </View>
